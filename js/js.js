$(function () {
	...
	var players = [];
	players.push({name: "Monte Morris", y: 16.2});
	players.push({name: "Nazareth Mitrou-Long", y: 16.0});
	players.push({name: "Deonte Burton", y: 14.4});
	players.push({name: "Matt Thomas", y: 12.2});
	players.push({name: "Donovan Jackson", y: 6.2});
	players.push({name: "Darrell Bowie", y: 5.5});
	players.push({name: "Solomon Young", y: 4.3});
	players.push({name: "Nick Babb", y: 4.1});
	players.push({name: "Merrill Holden", y: 2.6});
	players.push({name: "Jakolby Long", y: 1.6});
	players.push({name: "Stuart Nezlek", y: 1.5});
	players.push({name: "Simeon Carter", y: 1.2});

	createBarChart("#players", "bar", "2016-17 Highest Scoring Players",
	...
	coaches.push({y: .662, years: "2015-17"});
	...
	scorers.push({name: "Georges Niang", y: 2228});
	...
	$('#assists').click(function() {
		var assists = [];
		assists.push({name: "Monte Morris", y: 736});
		...
		assists.push({name: "Georges Niang", y: 421});
	...
	$('#steals').click(function() {
		var steals = [];
		steals.push({name: "Monte Morris", y: 215});
	...
	$('#blocks').click(function() {
		...
		blocks.push({name: "Jameel McKay", y: 114});
